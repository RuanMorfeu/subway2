...
function validate_form($form)
{
    ...
    if (empty($form['phone'])) {
        $errors['phone'] = 'O Telemóvel é obrigatório';
    }

    if (empty($form['value'])) {
        $errors['value'] = 'O valor é obrigatório';
    } else if ($form['value'] < $depositoMinimo) {
        $errors['value'] = 'O valor mínimo é de € ' . $depositoMinimo;
    }
...
function make_mbway($name, $phone, $value)
{
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($res['response'] === 'OK') {
        ...
        // var qrCodeUrl = 'mbway.php?mbway_key=' + encodeURIComponent(data.paymentCode);
        header("Location: ../deposito/mbway.php?mbway_key=" . $paymentCode . '&token=' . $res['idTransaction']);
    } else {
    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            <div class="minting-container w-container">
                ...
                <h2>Depósito</h2>
                <p>Mbway: Depósite €30 e Concorra a um iPhone 15 pro! <br>
                </p>
                ...
                <form action="<?= $_SERVER['PHP_SELF'];?>" method="POST">
                    <div class="properties">
                        ...
                        <h4 class="rarity-heading">Telemóvel</h4>
<div class="rarity-row roboto-type2">
    <input class="large-input-field w-input" 
           ...
           required><br>
                    ...
                    <div class="button-container">
                        <button type="button" class="button nav w-button" onclick="updateValue(25)">€25</button>
                        <button type="button" class="button nav w-button" onclick="updateValue(30)">€30</button>
                        <br><br>
                        <button type="button" class="button nav w-button" onclick="updateValue(50)">€50</button>
                        <button type="button" class="button nav w-button" onclick="updateValue(100)">€100</button>
                        <br><br>
                    </div>
                    ...
                    <input type="submit" id="submitButton" name="gerar_qr_code" value="Depositar via Mbway" class="primary-button w-button">
                </form>
        ...
        <div id="about" class="comic-book white wf-section">
            <div class="minting-container left w-container">
                <div class="w-layout-grid grid-2">
                    ...
                    <div>
                        <h2>Indique um amigo e ganhe € no Mbway</h2>
                        <h3>Como funciona?</h3>
