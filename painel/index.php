...
<div id="saldoDiv" style="position: absolute; top: 100px; width: 100%; line-height: 26px; color: #fff; z-index: 10; text-align: center;">
        SALDO: €<b class="saldo"> <?php echo isset($saldo) ? number_format($saldo, 2, ',', '.') : '0,00'; ?> </b>
    </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            <?php if (isset($saldo)): ?>
                saldoDiv.innerHTML = 'SALDO: €<b class="saldo">' + <?php echo json_encode(number_format($saldo, 2, ',', '.')); ?> + '</b>';
            <?php endif; ?>
        };
    </script>
...
<p>O saque é instantâneo. Utilizamos a transferência instantânea para enviar o pagamento 7 dias por semana e 24 horas por dia. <br>
</p>
</div>
<div class="question">
...
<li>Seu amigo deve ter depositado pelo menos 15.00 EUR para receber o prêmio do convite.
</li>
...
<div style="visibility: visible;">
    ...
    <script>
        ...
        var notifications = [
            ...
            '<strong>Antonela</strong> Acabou de Sacar <strong>€ 130,00 </strong>',
