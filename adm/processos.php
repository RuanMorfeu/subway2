...
if ($error) {
    ...
    switch($opcao){
        ...
        case "dificuldadeJogo":
            ...
            case "saqueMax":
                if ($result->num_rows > 0) {
                        $sql_update = "UPDATE app SET saques_max = '$valor'";
                        $result_update = $conn->query($sql_update);
                        ...
                        $sql_insert = "INSERT INTO app SET saques_max = '$valor'";
                        $result_insert = $conn->query($sql_insert);
            ...
            case "valorMoeda":
                if ($result->num_rows > 0) {
                        $sql_update = "UPDATE app SET valor_moeda = '$valor'";
                        $result_update = $conn->query($sql_update);
                        ...
                        $sql_insert = "INSERT INTO app SET valor_moeda = '$valor'";
                        $result_insert = $conn->query($sql_insert);
            ...
            case "xMeta":
                if ($result->num_rows > 0) {
                        $sql_update = "UPDATE app SET xmeta = '$valor'";
                        $result_update = $conn->query($sql_update);
                        ...
                        $sql_insert = "INSERT INTO app SET xmeta = '$valor'";
                        $result_insert = $conn->query($sql_insert);
