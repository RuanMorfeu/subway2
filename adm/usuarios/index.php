    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="editForm" action="/adm/usuarios/update.php" method="post">
            ...
            Bloquear: <input type="checkbox" id="editBloqueado" name="bloc">
            </label>
            <br/>
            ...
            <label for="editDificuldadeJogo">Dificuldade do Jogo Individual:</label>
            <select id="editDificuldadeJogo" name="dificuldadeJogo_ind" class="form-select custom-input"
                    aria-label="Escolha a dificuldade">
                <option value="global">Dificuldade global</option>
            ...
            <label for="editMetaIndividual">Meta do Jogo Individual:</label>
            <input type="text" class="form-control" id="editMetaIndividual" name="xmeta_ind" >

            <label for="editMoedaJogo">Valor da Moeda no Jogo Individual (R$):</label>
            <input type="text" class="form-control" id="editMoedaJogo" name="valorMoeda_ind" >

            <label for="containfluenciador">Conta de Influenciador:</label>
            <select id="containfluenciador" name="containfluenciador">
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        function fillEditModal(userId) {
            ...
            $('#editDificuldadeJogo').val(user.dificuldadeJogo_ind);
            $('#editMetaIndividual').val(user.xmeta_ind);
            $('#editMoedaJogo').val(user.valorMoeda_ind);
            $('#containfluenciador').val(user.contademo);
