...
try {
    ...
    $sql = "SELECT id, data_cadastro, email, senha, telefone, saldo, linkafiliado, plano, depositou, bloc, saldo_comissao, percas, ganhos, cpa, cpafake, comissaofake, contademo, dificuldadeJogo_ind, xmeta_ind, valorMoeda_ind
            FROM appconfig";
