...
<body>
    ...
    <div id="popup" class="minting-container w-container"
        ...
        <div class="popup-content">
            ...
            <p>Parabéns campeão, você ganhou <strong>€
                    <?php echo $valor; ?>
    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <p class="win-warn"><strong>Uau! Continue assim, ganhou €
                        <?php echo $valor; ?>
                    </strong>
                </p>
                <p>Para começar a lucrar crie uma conta e faça seu depósito. #ficadica!</p>
                <strong style="margin-top: 20px"> ⬇️ Clique no Botão Abaixo</strong>

                <a href="../deposito/" class="cadastro-btn">Depositar</a>
