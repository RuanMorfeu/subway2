...
<head>
    ...
    <meta charset="pt-br">
    <title><?= $nomeUnico ?> - Solicitação de Saque Concluido!</title>
...
<body>
    ...
    height: 90vh;
            ...
            <div class="minting-container w-container" style="margin-top: -20%">
                ...
                <h2 style="color: green;">Olá!</H2> 
                <h2>SUA SOLICITAÇÃO DE SAQUE FOI CONCLUIDA!</h2>
                <br><p style="font-size: 20px;" class="win-warn"><strong>Você solicitou um saque no valor de <a style="color: #136b1a; font-size: 25px;">R$
                        <?php echo $valor; ?>!</a>
                    </strong>
                    <p>O valor já foi debitado de sua conta e estará disponível em até 24 horas!</p>
                </p>
                <br>
